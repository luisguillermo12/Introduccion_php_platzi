<?php
/*
namespaces : o espacio de nombres , es una caracteristicas q usamos en php para solucionar un problema de colicion de nombres ;
...
para especificar una clase q queremos utilizar 

$instacia = new Lib1\proyect();
 */
