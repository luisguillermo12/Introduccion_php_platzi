...
los archivo .phar son empaquetados de php 

ayuda de composer $ php composer.phar

para el composer funcionar debemos colocar el composer.phar en la carpeta raiz de nuestro proyecto y el composer .json tiene lo q querimos y el autoload de los archivos
 */
